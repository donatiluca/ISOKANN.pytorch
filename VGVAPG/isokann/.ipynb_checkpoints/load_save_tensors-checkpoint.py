...
print("\nThis will create tensors using all the atoms of the molecule\n")
...
# Generate atoms pairs
pairs   =   generate_pairs(Natoms)
Ndims   =   len(pairs)
print("Number of pairwise distances (all atoms):", Ndims)
...
d0  =  md.compute_distances(traj, pairs, periodic=False)
